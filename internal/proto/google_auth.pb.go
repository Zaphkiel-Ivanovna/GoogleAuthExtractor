...
// 	protoc        v5.29.3
// source: internal/proto/google_auth.proto
...
func (MigrationPayload_Algorithm) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_proto_google_auth_proto_enumTypes[0].Descriptor()
}

func (MigrationPayload_Algorithm) Type() protoreflect.EnumType {
	return &file_internal_proto_google_auth_proto_enumTypes[0]
}
...
func (MigrationPayload_Algorithm) EnumDescriptor() ([]byte, []int) {
	return file_internal_proto_google_auth_proto_rawDescGZIP(), []int{0, 0}
}
...
const (
	...
	MigrationPayload_SEVEN                   MigrationPayload_DigitCount = 3
)
...
func (MigrationPayload_DigitCount) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_proto_google_auth_proto_enumTypes[1].Descriptor()
}

func (MigrationPayload_DigitCount) Type() protoreflect.EnumType {
	return &file_internal_proto_google_auth_proto_enumTypes[1]
}
...
func (MigrationPayload_DigitCount) EnumDescriptor() ([]byte, []int) {
	return file_internal_proto_google_auth_proto_rawDescGZIP(), []int{0, 1}
}
...
func (MigrationPayload_OtpType) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_proto_google_auth_proto_enumTypes[2].Descriptor()
}

func (MigrationPayload_OtpType) Type() protoreflect.EnumType {
	return &file_internal_proto_google_auth_proto_enumTypes[2]
}
...
func (MigrationPayload_OtpType) EnumDescriptor() ([]byte, []int) {
	return file_internal_proto_google_auth_proto_rawDescGZIP(), []int{0, 2}
}
...
func (x *MigrationPayload) Reset() {
	*x = MigrationPayload{}
	mi := &file_internal_proto_google_auth_proto_msgTypes[0]
...
func (*MigrationPayload) Descriptor() ([]byte, []int) {
	return file_internal_proto_google_auth_proto_rawDescGZIP(), []int{0}
}
...
func (x *MigrationPayload_OtpParameters) Reset() {
	*x = MigrationPayload_OtpParameters{}
	mi := &file_internal_proto_google_auth_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *MigrationPayload_OtpParameters) GetUniqueId() string {
	if x != nil {
		return x.UniqueId
	}
	return ""
...
var File_internal_proto_google_auth_proto protoreflect.FileDescriptor

const file_internal_proto_google_auth_proto_rawDesc = "" +
	"\n" +
	" internal/proto/google_auth.proto\x12\n" +
	"googleauth\"\xfe\x05\n" +
	...
	"batchIndex\x12\x19\n" +
	"\bbatch_id\x18\x05 \x01(\x05R\abatchId\x1a\xcb\x02\n" +
	...
	"\acounter\x18\a \x01(\x03R\acounter\x12\x1b\n" +
	"\tunique_id\x18\b \x01(\tR\buniqueId\"Q\n" +
	"\tAlgorithm\x12\x19\n" +
	...
	"\x03SIX\x10\x01\x12\t\n" +
	"\x05EIGHT\x10\x02\x12\t\n" +
	"\x05SEVEN\x10\x03\"7\n" +
	"\aOtpType\x12\x18\n" +
	"\x14OTP_TYPE_UNSPECIFIED\x10\x00\x12\b\n" +
	"\x04HOTP\x10\x01\x12\b\n" +
	"\x04TOTP\x10\x02BAZ?github.com/Zaphkiel-Ivanovna/GoogleAuthExtractor/internal/protob\x06proto3"

var (
	file_internal_proto_google_auth_proto_rawDescOnce sync.Once
	file_internal_proto_google_auth_proto_rawDescData []byte
)

func file_internal_proto_google_auth_proto_rawDescGZIP() []byte {
	file_internal_proto_google_auth_proto_rawDescOnce.Do(func() {
		file_internal_proto_google_auth_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_internal_proto_google_auth_proto_rawDesc), len(file_internal_proto_google_auth_proto_rawDesc)))
	})
	return file_internal_proto_google_auth_proto_rawDescData
}

var file_internal_proto_google_auth_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_internal_proto_google_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_internal_proto_google_auth_proto_goTypes = []any{
	(MigrationPayload_Algorithm)(0),        // 0: googleauth.MigrationPayload.Algorithm
	(MigrationPayload_DigitCount)(0),       // 1: googleauth.MigrationPayload.DigitCount
	(MigrationPayload_OtpType)(0),          // 2: googleauth.MigrationPayload.OtpType
...
var file_internal_proto_google_auth_proto_depIdxs = []int32{
	...
	1, // 2: googleauth.MigrationPayload.OtpParameters.digits:type_name -> googleauth.MigrationPayload.DigitCount
	2, // 3: googleauth.MigrationPayload.OtpParameters.type:type_name -> googleauth.MigrationPayload.OtpType
...
func init() { file_internal_proto_google_auth_proto_init() }
func file_internal_proto_google_auth_proto_init() {
	if File_internal_proto_google_auth_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_internal_proto_google_auth_proto_rawDesc), len(file_internal_proto_google_auth_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_internal_proto_google_auth_proto_goTypes,
		DependencyIndexes: file_internal_proto_google_auth_proto_depIdxs,
		EnumInfos:         file_internal_proto_google_auth_proto_enumTypes,
		MessageInfos:      file_internal_proto_google_auth_proto_msgTypes,
	}.Build()
	File_internal_proto_google_auth_proto = out.File
	file_internal_proto_google_auth_proto_goTypes = nil
	file_internal_proto_google_auth_proto_depIdxs = nil
}
